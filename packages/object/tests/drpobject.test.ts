...
describe("AccessControl tests with RevokeWins resolution", () => {
	...
	test("Test creating DRPObject wo/ ACL", () => {
		const obj = new DRPObject2({ peerId: "" });
...
describe("Drp Object should be able to change state value object 1", () => {
	let drpObject: DRPObject2<SetDRP<number>>;

	beforeEach(() => {
		drpObject = new DRPObject2({ peerId: "peer1", acl, drp: new SetDRP<number>() });
	});
...
describe("Async counter DRP", () => {
	let drpObject1: DRPObject2<AsyncCounterDRP>;
	let drpObject2: DRPObject2<AsyncCounterDRP>;

	beforeEach(() => {
		drpObject1 = new DRPObject2({ peerId: "peer1", acl, drp: new AsyncCounterDRP() });
		drpObject2 = new DRPObject2({ peerId: "peer2", acl, drp: new AsyncCounterDRP() });
	});
...
describe("Async push to array DRP", () => {
	let drpObject1: DRPObject2<AsyncPushToArrayDRP>;
	let drpObject2: DRPObject2<AsyncPushToArrayDRP>;

	beforeEach(() => {
		vi.useFakeTimers({ now: 0 });
		drpObject1 = new DRPObject2({ peerId: "peer1", acl, drp: new AsyncPushToArrayDRP() });
		drpObject2 = new DRPObject2({ peerId: "peer2", acl, drp: new AsyncPushToArrayDRP() });
	});
...
describe("DRPObject validation tests", () => {
	let obj1: DRPObject2<MapDRP<string, string>>;
	let obj2: DRPObject2<MapDRP<string, string>>;
	beforeEach(() => {
		obj1 = new DRPObject2({
			peerId: "peer1",
			acl,
...
describe("HashGraph hook tests", () => {
	...
	beforeEach(() => {
		obj1 = new DRPObject2({ peerId: "peer1", acl, drp: new SetDRP<number>() });
		obj2 = new DRPObject2({ peerId: "peer1", acl, drp: new SetDRP<number>() });
	});
...
describe("DRP Context tests", () => {
	let obj1: DRPObject2<SetDRPWithContext<number>>;
	let obj2: DRPObject2<SetDRPWithContext<number>>;
	let obj3: DRPObject2<SetDRPWithContext<number>>;

	beforeEach(() => {
		obj1 = new DRPObject2({ peerId: "peer1", acl, drp: new SetDRPWithContext<number>() });
		obj2 = new DRPObject2({ peerId: "peer2", acl, drp: new SetDRPWithContext<number>() });
		obj3 = new DRPObject2({ peerId: "peer3", acl, drp: new SetDRPWithContext<number>() });
	});
...
describe("HashGraph for set wins map tests", () => {
	let obj1: DRPObject2<MapDRP<string, string>>;
	let obj2: DRPObject2<MapDRP<string, string>>;
	let obj3: DRPObject2<MapDRP<string, string>>;
...
describe("Hashgraph for SetDRP and ACL tests", () => {
	...
	beforeEach(async () => {
		...
		obj1 = new DRPObject2({ peerId: "peer1", acl, drp: new SetDRP<number>() });
		obj2 = new DRPObject2({ peerId: "peer2", acl, drp: new SetDRP<number>() });
		obj3 = new DRPObject2({ peerId: "peer3", acl, drp: new SetDRP<number>() });
...
describe("Hashgraph for SetDRP and ACL tests", () => {
	test("Should use ACL on dependencies to determine if vertex is valid", async () => {
		...
		*/
		...
		const obj1 = new DRPObject2({ peerId: "peer1", acl, drp: new SetDRP<number>() });
		const obj2 = new DRPObject2({ peerId: "peer2", acl, drp: new SetDRP<number>() });
